 ...
 * returns both the ipv4 Address and the mapped ipv6 address
 * @param {string} cidrStr - The IPv4 subnet expressed
 *                 in CIDR format.
 * @param {callback} callback - A callback function.
 * @return {object} - An object with both ipv4 and ipv6 properties
 */
...
function main() {
  ...
  for (let i = 0; i < sampleIpv4sLen; i++) {
    ...
    let {ipv6: mappedAddress} = getIpv4MappedIpv6Address(sampleIpv4s[i]) || {};
    if( mappedAddress ) {
